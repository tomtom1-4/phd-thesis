...
\begin{equation}
  ...
  \end{split}
\end{equation}
\todo{Check if this idea is equivalent to what was presented in \cite{Anastasiou:2014lda}}
...
We can therefore apply techniques from \textit{soft-collinear effective theory} (\acs{SCET})~\cite{Bauer:2001yt, Bauer:2002nz} to map the Higgs-gluon form factor to the Wilson coefficients of the \acs{SCET}. Then the large logarithms can be resummed to all orders of perturbation theory using the \acs{RGE} of the Wilson coefficient~\cite{Ahrens:2008qu}.
