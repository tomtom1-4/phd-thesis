...
\end{equation}
In the highly accurate narrow width approximation $\Gamma_H/m_H \ll 0$, subsequent decays of the Higgs boson can be approximated via
\begin{equation}
\sigma_{pp \rightarrow H \rightarrow X} = \sigma_{pp \rightarrow H} \frac{\Gamma_{H \rightarrow X}}{ \Gamma_H},
\end{equation}
where $\Gamma_H$ is the total decay width of the Higgs. In the high-luminosity phase of the \acs{LHC}, the cross section for the production of a Higgs and its subsequent decay are expected to be reduced even further (see Tab.~\ref{tab:4:HLLHC_projections}).
\begin{table}[h]
\centering
\begin{tabular}{ccc}
...
$H \rightarrow W Z^*$ & $\pm 1$ (stat.) $\pm 3$ (sys.) & $\pm 1$ (stat.) $\pm 4$ (sys.) \\
