...
\captionof{figure}{Partonic luminosity of parton $i$ and $j$. We choose exemplary parton combinations to represent gluon--gluon, gluon--valence-quark, gluon--sea-quark, valence-quark--sea-quark, valence-quark--valence-quark and sea-quark--sea-quark luminosities. For the luminosity of two different partons we include a factor $2$ to account for the different flavor permutations. The setup is the same as in Fig.~\ref{fig:2:PDF}.}
