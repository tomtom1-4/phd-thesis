...
The number of quark flavors treated as active (massless) partons defines our \emph{flavor scheme}. For instance, if we treat the lightest four flavors (up, down, strange, charm) as massless, while considering the bottom and top quarks as massive, we are working in the four-flavor scheme (4FS). Analogously, if the bottom quark is also considered massless, we are working in the five-flavor scheme (5FS), and so on.
